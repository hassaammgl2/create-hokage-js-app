    ...
    return (
        <form onSubmit={handleSubmit} className="flex min-h-screen w-full">
            ...
            <div className="flex flex-1 shrink-0 flex-col items-center justify-center gap-4 overflow-auto">
                ...
                {formMessage && (
                    <div className={`mb-4 rounded-md px-3 py-2.5 text-center text-sm ${formMessageStatus === true ? 'border border-emerald-500/30 bg-emerald-500/10 text-emerald-400' : 'border border-red-500/30 bg-red-500/10 text-red-400'}`}>
                        {formMessage}
                    </div>
                )}
